...
export default function Footer() {
  return (
    <footer className={tw`mx-auto max-w-[1920px] px-6 bg-gray-900`}>
      <div
        className={tw`grid grid-cols-1 lg:grid-cols-12 gap-8 border-b border-gray-600 py-12 text-white transition-colors duration-150 bg-gray-900`}
      >
