...
export interface paths {
  ...
  "/items/user_auth_events": {
    /**
     * List Items 
     * @description List the user_auth_events items.
     */
    get: operations["readItemsUserAuthEvents"];
    /**
     * Create an Item 
     * @description Create a new user_auth_events item.
     */
    post: operations["createItemsUserAuthEvents"];
  };
  "/items/user_auth_events/{id}": {
    /**
     * Retrieve an Item 
     * @description Retrieve a single user_auth_events item by unique identifier.
     */
    get: operations["readSingleItemsUserAuthEvents"];
    /**
     * Delete an Item 
     * @description Delete an existing user_auth_events item.
     */
    delete: operations["deleteSingleItemsUserAuthEvents"];
    /**
     * Update an Item 
     * @description Update an existing user_auth_events item.
     */
    patch: operations["updateSingleItemsUserAuthEvents"];
  };
...
export interface operations {
  ...
  readItemsUserAuthEvents: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: (components["schemas"]["ItemsUserAuthEvents"])[];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsUserAuthEvents: {
    ...
    requestBody?: {
      content: {
        "application/json": (components["schemas"]["ItemsUserAuthEvents"])[] | components["schemas"]["ItemsUserAuthEvents"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  deleteSingleItemsUserAuthEvents: {
    /**
     * Delete an Item 
     * @description Delete an existing user_auth_events item.
     */
  ...
  updateSingleItemsUserAuthEvents: {
    /**
     * Update an Item 
     * @description Update an existing user_auth_events item.
     */
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsUserAuthEvents"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type UserAuthEvent = components["schemas"]["ItemsUserAuthEvents"];
