      ...
      <Html lang="en">
        ...
        >
          ...
          <Script
            ...
            strategy="afterInteractive"
            dangerouslySetInnerHTML={{
              __html: `window.codySettings = { widget_id: 'f9b9899d-a39f-459e-a9e0-143daf7e8aa6', icon: 'question', color: '#af72ab' };
                      !function(){var t=window,e=document,a=function(){a.init(arguments)},n=window.codySettings.base_url||"https://getcody.ai";
                      t.Cody=a;var i=function(){var t=e.createElement("script");
