...
export default function SubscribePage() {
  const { member, loading } = useUser({ forceLogin: true })
    return <>
      <Script async src="https://js.stripe.com/v3/pricing-table.js" />
      <Page loading={loading} title="Subscribe" description="Add features to your experience" requireAuth>
        <Text fontSize="lg" align="center" mb={4} mx={[0, 20, 40, 60]}>
          Approved and verified members always get event invites for free. Additional features are available for a small fee.
        </Text>
        <Text fontSize="xl" align="center" mb={4} mx={[0, 20, 40, 60]}>
          Select your plan from the options below:
        </Text>
        <stripe-pricing-table pricing-table-id="prctbl_1NFMnREoEUGL2BgulhFG0mBz"
