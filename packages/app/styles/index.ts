export default {
  ...
  pLg: `mb-5 text-lg text-justify sm:text-left md:text-left text-base sm:text-xl md:text-2xl`,
  p: `my-5 text-md text-justify sm:text-left md:text-left text-base `,
  ...
  infoIcon: `w-3 h-3 ml-1 mb-2 text-xs text-gray-400 hover:text-gray-500 cursor-help pb-[1]`,
};
